...
(function (context) {
	...
	*/
	...
	var JSPATH = REAPIPATH + '/javascripts/';
	...
	yepnope([
		...
		load: (function () {
			var arr = [];
			for(var i = 0; i < lib.src0.length; i++) {
				arr.push(JSPATH + lib.src0[i])
			}
			return arr;
		...
		load: (function () {
			var arr = [];
			for(var i = 0; i < lib.src1.length; i++) {
				arr.push(JSPATH + lib.src1[i])
			}
			return arr;
